    ...
    return <header id='header_container'>
        <nav className="nav-section" aria-label="Main navigation">
            <div className="nav-links">
                <a href="#redirect-intro" aria-label="Go to home section">
                    <span>
                        Home
                    </span>
                </a>
                <a href="#redirect-tech-stack" aria-label="Go to tech stack section">
                    <span>
                        Tech Stack
                    </span>
                </a>
                <a href="#redirect-about" aria-label="Go to about section">
                    <span>
                        About
                    </span>
                </a>
                ...
                <a
                    ...
                    aria-label="Download Arindam's Resume"
            ...
            <div className="logo-section">
                <a href="https://github.com/arindam1903"
                    aria-label="Visit Arindam's GitHub Profile"
                    target="_blank"
                    rel="noopener noreferrer"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" width="31" height="30" viewBox="0 0 31 30" fill="none" aria-hidden="true" role="img">
                        <title>GitHub</title>
                ...
                <a href="https://twitter.com/arindam_1903"
                    aria-label="Follow Arindam on Twitter"
                    target="_blank"
                    rel="noopener noreferrer"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32" fill="none" aria-hidden="true" role="img">
                        <title>Twitter</title>
                ...
                <a href="https://www.linkedin.com/in/arindam1903/"
                    aria-label="Connect with Arindam on LinkedIn"
                    target="_blank"
                    rel="noopener noreferrer"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" width="31" height="30" viewBox="0 0 31 30" fill="none" aria-hidden="true" role="img">
