...
const jobExp = [
    ...
    },
    {
        ...
        highlights: [
            'As part of the Platform R&D team, profiled bottlenecks and shipped systematic performance improvements across 30+ company-wide products',
            'Built CI/CD quality gates for E2E, unit, and visual regression testing, including automated accessibility checks in GitHub Actions',
            'Migrated the build pipeline from webpack to Vite, cutting bundle size by 70% and enabling near-instant HMR in local development',
        ],
    },
    {
        ...
        highlights: [
            'As a founding engineer, architected and shipped the product platform end-to-end — authentication, onboarding, and payments',
            'Scaled a node-based knowledge graph to 10,000+ nodes with virtualization and memoization, reducing render time and removing performance bottlenecks',
            'Built a user management system with role-based access control (RBAC) serving 500+ users across admin and super-admin tiers',
        ],
    },
]
...
export default function About() {
    return <div id='about_container'>
        <div id='redirect-about'>
            ...
            <p>
                Full-stack software engineer with 5+ years of experience shipping scalable product platforms, now focused on AI-driven systems. I own features end-to-end — APIs, data models, LLM/vision pipelines, and product surfaces — across startup and enterprise environments.
            </p>
        </div>
        <div>
            <span className="header-text">Work Experience</span>
            {jobExp.map((item) => {
                return <span className="job-desc d-block" key={`${item.company}-${item.duration}`}>
        ...
        <div>
            ...
            <span className="job-desc d-block">
                <span className="d-block">
                    <span className="designation">
                        B.Tech (Mechanical Engineering)</span>
                    <span className="type">DGPA 7.27</span>
                </span>
                <span className="d-block">
                    <span className="company">
                        <CompanyIcon />
